...
namespace UMapx.Imaging
{
    ...
    public class SingleScaleRetinex : LocalCorrection, IBitmapFilter2
    {
        ...
        public SingleScaleRetinex(int radius, Space space, float a = 1, float b = 0, float nbase = MathF.Pi)
        {
        ...
        /// <param name="b">Offset (0, 1]</param>
        /// <param name="nbase">Logarithm base</param>
        public SingleScaleRetinex(int width, int height, Space space, float a = 1, float b = 0, float nbase = MathF.Pi)
        {
        ...
        /// <param name="b">Offset (0, 1]</param>
        /// <param name="nbase">Logarithm base</param>
        public SingleScaleRetinex(SizeInt size, Space space, float a = 1, float b = 0, float nbase = MathF.Pi)
        {
            gb = new BoxBlur(size);
            Space = space; A = a; B = b; Base = nbase;
        }
