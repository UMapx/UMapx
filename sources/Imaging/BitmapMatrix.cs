    ...
    public static class BitmapMatrix
    {
            ...
            if (alpha)
            {
                ...
                Parallel.For(0, height, j =>
                {
                    ...
                    for (i = 0; i < width; i++)
                    {
                        ...
                        // recording model:
                        p[k + 0] = MathsF.Byte(x[j, i] * 255.0f);
                        p[k + 1] = MathsF.Byte(y[j, i] * 255.0f);
                        p[k + 2] = MathsF.Byte(z[j, i] * 255.0f);
                        p[k + 3] = MathsF.Byte(a[j, i] * 255.0f);
                    }
                });
            }
            else
        ...
        public unsafe static Bitmap FromGrayscale(this float[,] m)
        {
            ...
            Parallel.For(0, height, j =>
            {
                ...
                {
                    k = jstride + i * 4;
                    p[k + 2] = p[k + 1] = p[k] = MathsF.Byte(m[j, i] * 255.0f);
                    p[k + 3] = 255;
                }
            });
