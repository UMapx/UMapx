...
namespace UMapx.Colorspace
{
    ...
    public struct RGB : IColorSpace, ICloneable
    {
        ...
        public static RGB Saturation(int red, int green, int blue, float s)
        {
            ...
            // Result color:
            return new RGB(
                MathF.Byte(red + (red - max) * s),
                MathF.Byte(green + (green - max) * s),
                MathF.Byte(blue + (blue - max) * s));
        }
        /// <summary>
        /// Corrects color saturation.
        /// </summary>
        ...
        public static RGB Vibrance(int red, int green, int blue, float v)
        {
            ...
            byte nr = MathF.Byte(red + (red - max) * boost);
            byte ng = MathF.Byte(green + (green - max) * boost);
            byte nb = MathF.Byte(blue + (blue - max) * boost);
