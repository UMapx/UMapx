...
namespace UMapx.Window
{
    ...
    public partial class FastWeylHeisenbergTransform
    {
        ...
        ///   forward gain = 1/L and inverse uses the corresponding 1/gain as part of the unpacking
        ///   (here kept as <c>invGain = 1/(2L)</c> to match the user’s established convention and matrix reference).
        ///
        /// Complexity:
