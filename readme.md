...
**UMapx.NET** is based on several separate frameworks (AForge.NET, Accord.NET and etc). Some functions have been ported from other programming languages and their toolboxes and libraries (Fortran, MATLAB, C++, Python). The purpose of this generalization was the declarative understanding of algorithms and tools of digital signal processing, as well as optimization and performance improvement. **UMapx.NET** is faster than AForge.NET and Accord.NET in signal processing tasks and contains a larger set of functions for matrix analysis, linear algebra and functional analysis tasks. 
