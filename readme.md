...
| Version | Platform | Type | Download | Package |
|:-------------|:-------------|:-------------|:--------------|:--------------|
| 4.0.3.3 | .NET Standard 2.0 | AnyCPU | [Release](https://github.com/asiryan/UMapx.NET/releases/) | [NuGet](https://www.nuget.org/packages/UMapx/) |
