...
The current results are explained in [the special-function repair report](../special-functions-repair-2026-09-10.md).
...
| [DistributionReferenceTests.MatchesIndependentProbabilityReference](../../tests/UMapx.Tests/DistributionReferenceTests.cs) | 50 | Expected 13.6; actual 9.1999998092651367; tolerance 0.0292. |
...
| [DistributionShapeAuditTests.ModesAndMediansSatisfyTheirProbabilityDefinitions](../../tests/UMapx.Tests/DistributionShapeAuditTests.cs) | 8 | Median 2: F(m-)=0.50999999, F(m)=1. |
...
| [MathematicalRegressionTests.InverseChiSquareEntropyAgreesWithInverseGamma](../../tests/UMapx.Tests/MathematicalRegressionTests.cs) | 1 | Expected 1.4612841492431206; actual 0.30685281753540039; tolerance 3.12257E-05. |
